...
class PatternFinder(LightningModule):
    ...
    def __init__(self, in_channels, series_medians, multf=2):
        ...
        #self.block3 = Dablock(in_channels, multf)
                        ...
                        # in_channels*multf*4 * 3 + \
                        # in_channels*multf*4 * 2 + \
        input_width =   in_channels*multf*4 * 3 + \
                        in_channels*multf*3 * 2 + \
                        3
...
class Dablock(LightningModule):
    ...
    def __init__(self, in_channels, multf, dilation=1, ch_dropout=0):
        ...
        self.conv30 = nn.Conv1d(in_channels*multf*3, in_channels*multf*4, kernel_size=self.ks, stride=1, padding=0, bias=True)
        self.conv31 = nn.Conv1d(in_channels*multf*4, in_channels*multf*4, kernel_size=self.ks, stride=1, padding=0, bias=True)
